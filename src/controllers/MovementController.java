...
public class MovementController extends KeyAdapter { //keyadapter statt keylistener (hat schon alles vom keylistener drin, aber man definiert selbst nur die Methoden, die man braucht
    ...
    public MovementController(final Player p) { 
        this.p = p; // wird genutzt, da man das Koordinatensystem aus der Klasse Player verwenden will
    }

    /* Methode, damit man mit genannten Tasten steuern kann*/
    ...
    /* Methode für smooth movements: wenn eine dieser Tasten losgelassen wird, wird die Geschwindigkeit in y-Richtung auf 0 gesetzt*/
