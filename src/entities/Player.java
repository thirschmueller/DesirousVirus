...
public class Player extends IGameObject {	//mit IGameObject extende, dass man das Koordinatensystem verwenden kann
    ...
    public void tick() {
        super.x += super.velX;	//super, weil es alles aus player und IGameObjects nutzen soll
        super.y += super.velY;
